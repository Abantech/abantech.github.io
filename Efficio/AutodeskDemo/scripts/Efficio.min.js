...
;
﻿define('Human Input Recognition and Processing/Input Extensions/Intel/RealSense/IntelRealSenseHandExtensions',['realsense', 'Helpers/Math'], function (realsense, math) {
...
;
﻿// TODO migrate this to the hand extensions
    ...
    function Initialize(EfficioConfiguration) {
        ...
        if (EfficioConfiguration.Devices.RealSense) {
            (function RealSensePrototypeExtensions() {
                ...
                require(['Human Input Recognition and Processing/Input Extensions/Intel/RealSense/IntelRealSenseHandExtensions'], function (RSHE) {
                    hipr.PrototypeExtensions.RealSense.Hand = RSHE.ExtendClasses();
                });
            })();
        }
