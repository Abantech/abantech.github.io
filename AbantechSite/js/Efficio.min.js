...
;
﻿define('Human Input Recognition and Processing/Input Extensions/LeapMotion/HandExtensions',['leapjs', 'Helpers/Math'], function (Leap, math) {
...
;
﻿define('Human Input Recognition and Processing/Input Extensions/LeapMotion/FingerExtensions',[], function () {
...
﻿define('Human Input Recognition and Processing/Input Extensions/Intel/RealSense/HandExtensions',['realsense', 'Helpers/Math'], function (realsense, math) {
...
;
﻿define('Human Input Recognition and Processing/Hand Gestures/One Hand Gestures/OneHandPositionDetection',['postal'], function (bus) {
...
﻿define('Human Input Recognition and Processing/Hand Gestures/One Hand Gestures/OneHandGestureDetection',['postal', 'Helpers/Math'], function (bus, math) {
    var source = 'Efficio Gesture Grimoire';
    var name = 'One Hand Gesture Detector';
...
﻿define('Human Input Recognition and Processing/Hand Gestures/Two Hand Gestures/TwoHandPositionDetection',['postal', 'Helpers/Math'], function (bus, math) {
    var source = 'Efficio Gesture Grimoire';
...
﻿define('Input/Accelerometer/Browser',['postal', 'Input/DeviceManager', 'gyronorm'], function (bus, deviceManager, gnobj) {
...
function (hirp, ami, constraintsEngine, comm, internalScene, sysNotificationListener, deviceManager, metrics) {
    ...
    function Ready() {
        ...
        if (Efficio.Configuration.Devices.Microphone && !Efficio.DeviceManager.RegisteredDevices.Microphone) {
            ready = false;
        }
