...
﻿define('Input/Intel/RealSense/Sense Type/Hands/HelperFunctions',[], function () {
    ...
    function NormalizePoint(frame, point) {
        ...
        if (Efficio.Configuration.Devices.RealSense.Frame) {
            tempFrame = Efficio.Configuration.Devices.RealSense.Frame;
        }
        ...
        if (tempPoint.x < tempFrame.Minimums.x)
            tempPoint.x = tempFrame.Minimums.x;

        if (tempPoint.x > tempFrame.Maximums.x)
            tempPoint.x = tempFrame.Maximums.x

        if (tempPoint.y < tempFrame.Minimums.y)
            tempPoint.y = tempFrame.Minimums.y;

        if (tempPoint.y > tempFrame.Maximums.y)
            tempPoint.y = tempFrame.Maximums.y

        if (tempPoint.z < tempFrame.Minimums.z)
            tempPoint.z = tempFrame.Minimums.z;

        if (tempPoint.z > tempFrame.Maximums.z)
            tempPoint.z = tempFrame.Maximums.z

        return [
            (tempPoint.x - tempFrame.Minimums.x) / ((tempFrame.Maximums.x - tempFrame.Minimums.x) * 10) * 10,
            (tempPoint.y - tempFrame.Minimums.y) / ((tempFrame.Maximums.y - tempFrame.Minimums.y) * 10) * 10,
            (tempPoint.z - tempFrame.Minimums.z) / ((tempFrame.Maximums.z - tempFrame.Minimums.z) * 10) * 10
        ]
    }
...
;
﻿define('Input/Intel/RealSense/Sense Type/Hands/HandTracking',['postal', 'Input/DeviceManager', 'Input/Intel/RealSense/Sense Type/Hands/HelperFunctions'], function (bus, deviceManager, helper) {
